...
// Error component - clears wagmi cache for chain errors
  ...
  return (
    <main className="min-h-screen animated-bg flex items-center justify-center">
      <div className="text-center p-8 max-w-md">
        ...
        <p className="text-yellow-400 mb-2 font-bold">Connection issue</p>
        <p className="text-gray-400 text-sm mb-4">Your wallet may be on an unsupported network. Click below to reset.</p>
        <button 
          onClick={handleReset}
